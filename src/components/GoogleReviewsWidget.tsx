    ...
    <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-background rounded-2xl p-6 md:p-8 shadow-lg border mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              {reviewUrl && (
                <Button asChild className="gap-2 bg-gradient-orange shadow-orange hover:opacity-90">
          ...
          {hasRealReviews && (
            ...
            >
              <CarouselContent className="-ml-4">
                {reviews.map((review, index) => (
                  <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                    <div className="bg-background rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                      ...
                      <div className="relative flex-1">
                        ...
                        <p className="text-muted-foreground text-sm pl-4 line-clamp-5">
                          {review.text}
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex items-center justify-center gap-4 mt-6">
                <CarouselPrevious className="static translate-y-0 bg-background border shadow-sm hover:bg-muted" />
                <CarouselNext className="static translate-y-0 bg-background border shadow-sm hover:bg-muted" />
              </div>
            </Carousel>
          )}
        </div>
